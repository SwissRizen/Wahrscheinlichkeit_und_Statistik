...
\begin{subbox}{}
    Seien $X_1, \ldots, X_n$ \tbf{discretee} Random Variables in $(\Omega, \F, \P)$, sodass $X_1 \in W_1, \ldots, X_n \in W_n$ a.s. für $W_1, \ldots, W_n \subset \R$ finite oder countable.
